...
unur_reset_errno();
n_tests_failed += (check_expected_INFINITY(TESTLOG,53,(unur_quantile(gen,0.5)))==UNUR_SUCCESS)?0:1;
n_tests_failed += (check_errorcode(TESTLOG,53,UNUR_ERR_NO_QUANTILE)==UNUR_SUCCESS)?0:1;
...
UNUR_GEN   *gen = NULL;
   ...
   gen = unur_init( par ); 
abort_if_NULL(TESTLOG, 59,    gen );


unur_reset_errno();
unur_quantile(gen,0.5);
n_tests_failed += (check_errorcode(TESTLOG,63,UNUR_SUCCESS)==UNUR_SUCCESS)?0:1;
unur_distr_free(distr);
unur_free(gen);
}
...
UNUR_GEN   *gen = NULL;
   ...
   gen = unur_init( par ); 
abort_if_NULL(TESTLOG, 69,    gen );


unur_reset_errno();
unur_quantile(gen,0.5);
n_tests_failed += (check_errorcode(TESTLOG,73,UNUR_SUCCESS)==UNUR_SUCCESS)?0:1;
unur_distr_free(distr);
unur_free(gen);
}
...
UNUR_GEN   *gen = NULL;
   ...
   gen = unur_init( par ); 
abort_if_NULL(TESTLOG, 80,    gen );


unur_reset_errno();
unur_quantile(gen,0.5);
n_tests_failed += (check_errorcode(TESTLOG,84,UNUR_SUCCESS)==UNUR_SUCCESS)?0:1;
unur_distr_free(distr);
unur_free(gen);
}
...
UNUR_GEN   *gen = NULL;
   ...
   gen = unur_init( par ); 
abort_if_NULL(TESTLOG, 89,    gen );


unur_reset_errno();
unur_quantile(gen,0.5);
n_tests_failed += (check_errorcode(TESTLOG,93,UNUR_SUCCESS)==UNUR_SUCCESS)?0:1;
unur_distr_free(distr);
unur_free(gen);
}
...
unur_reset_errno();
unur_quantile(gen,0.5);
n_tests_failed += (check_errorcode(TESTLOG,102,UNUR_SUCCESS)==UNUR_SUCCESS)?0:1;
unur_distr_free(distr);
unur_free(gen);
}
...
unur_reset_errno();
unur_quantile(gen,0.5);
n_tests_failed += (check_errorcode(TESTLOG,111,UNUR_SUCCESS)==UNUR_SUCCESS)?0:1;
unur_distr_free(distr);
unur_free(gen);
}
