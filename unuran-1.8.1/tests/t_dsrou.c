...
unur_reset_errno();
n_tests_failed += (check_expected_NULL(TESTLOG,35,(unur_dsrou_new( distr )))==UNUR_SUCCESS)?0:1;
...
unur_reset_errno();
n_tests_failed += (check_expected_NULL(TESTLOG,41,(unur_dsrou_new( distr )))==UNUR_SUCCESS)?0:1;
...
unur_reset_errno();
/* pmf, mode, pmfsum */
n_tests_failed += (check_expected_NULL(TESTLOG,48,(unur_dsrou_new( distr )))==UNUR_SUCCESS)?0:1;
...
unur_reset_errno();
n_tests_failed += (check_expected_setfailed(TESTLOG,58,(unur_dsrou_set_cdfatmode(par,0.)))==UNUR_SUCCESS)?0:1;
n_tests_failed += (check_errorcode(TESTLOG,58,UNUR_ERR_NULL)==UNUR_SUCCESS)?0:1;

unur_reset_errno();
n_tests_failed += (check_expected_setfailed(TESTLOG,61,(unur_dsrou_set_verify(par,1)))==UNUR_SUCCESS)?0:1;
...
unur_reset_errno();
n_tests_failed += (check_expected_setfailed(TESTLOG,69,(unur_dsrou_set_cdfatmode(par,0.)))==UNUR_SUCCESS)?0:1;
n_tests_failed += (check_errorcode(TESTLOG,69,UNUR_ERR_PAR_INVALID)==UNUR_SUCCESS)?0:1;

unur_reset_errno();
n_tests_failed += (check_expected_setfailed(TESTLOG,72,(unur_dsrou_set_verify(par,1)))==UNUR_SUCCESS)?0:1;
...
unur_reset_errno();
n_tests_failed += (check_expected_setfailed(TESTLOG,82,(unur_dsrou_set_cdfatmode(par,-1.)))==UNUR_SUCCESS)?0:1;
n_tests_failed += (check_errorcode(TESTLOG,82,UNUR_ERR_PAR_SET)==UNUR_SUCCESS)?0:1;
unur_par_free(par);
unur_distr_free(distr);
}
...
unur_reset_errno();
n_tests_failed += (check_expected_setfailed(TESTLOG,102,(unur_dsrou_chg_verify(gen,1)))==UNUR_SUCCESS)?0:1;
n_tests_failed += (check_errorcode(TESTLOG,102,UNUR_ERR_GEN_INVALID)==UNUR_SUCCESS)?0:1;

unur_reset_errno();
n_tests_failed += (check_expected_setfailed(TESTLOG,105,(unur_dsrou_chg_cdfatmode(gen,1.)))==UNUR_SUCCESS)?0:1;
n_tests_failed += (check_errorcode(TESTLOG,105,UNUR_ERR_GEN_INVALID)==UNUR_SUCCESS)?0:1;
unur_distr_free(distr);
unur_free(gen);
}
...
UNUR_GEN   *gen = NULL;
   ...
   par = unur_dsrou_new(distr);
   gen = unur_init( par ); 
abort_if_NULL(TESTLOG, 111,    gen );


unur_reset_errno();
n_tests_failed += (check_expected_setfailed(TESTLOG,115,(unur_dsrou_chg_cdfatmode(gen,-1.)))==UNUR_SUCCESS)?0:1;
...
unur_reset_errno();
n_tests_failed += (check_expected_NULL(TESTLOG,126,(unur_init( par )))==UNUR_SUCCESS)?0:1;
...
unur_reset_errno();
n_tests_failed += (check_expected_NULL(TESTLOG,137,(unur_init( par )))==UNUR_SUCCESS)?0:1;
n_tests_failed += (check_errorcode(TESTLOG,137,UNUR_ERR_GEN_DATA)==UNUR_SUCCESS)?0:1;
unur_distr_free(distr);
}
...
unur_distr_discr_set_pmf(distr,pmf);
par = unur_dsrou_new( distr );
n_tests_failed += (check_expected_NULL(TESTLOG,147,(unur_init(par)))==UNUR_SUCCESS)?0:1;
n_tests_failed += (check_errorcode(TESTLOG,147,UNUR_ERR_DISTR_REQUIRED)==UNUR_SUCCESS)?0:1;
...
n_tests_failed += (check_errorcode(TESTLOG,153,UNUR_ERR_DISTR_REQUIRED)==UNUR_SUCCESS)?0:1;
unur_distr_free(distr);
}
...
unur_reset_errno();
n_tests_failed += (check_expected_reinit(TESTLOG,166,(unur_reinit( gen )))==UNUR_SUCCESS)?0:1;
unur_distr_free(distr);
unur_free(gen);
}
...
/* default algorithm */
par = unur_dsrou_new(distr);
n_tests_failed += (compare_sequence_par_start(TESTLOG,179,par,COMPARE_SAMPLE_SIZE)==UNUR_SUCCESS)?0:1;
...
unur_dsrou_set_cdfatmode(par,0.1);
 run_verify_generator (TESTLOG,196,par);
n_tests_failed += (check_errorcode(TESTLOG,196,UNUR_ERR_GEN_CONDITION)==UNUR_SUCCESS)?0:1;
unur_distr_free(distr);
}
...
par = unur_dsrou_new(distr);
gen = unur_init(par);
n_tests_failed += (compare_sequence_gen_start(TESTLOG,210,gen,COMPARE_SAMPLE_SIZE)==UNUR_SUCCESS)?0:1;
...
unur_free(gen);
gen = clone;
n_tests_failed += (compare_sequence_gen(TESTLOG,216,gen,COMPARE_SAMPLE_SIZE)==UNUR_SUCCESS)?0:1;
unur_distr_free(distr);
unur_free(gen);
}
...
par = unur_dsrou_new(distr);
gen = unur_init(par);
n_tests_failed += (compare_sequence_gen_start(TESTLOG,229,gen,COMPARE_SAMPLE_SIZE)==UNUR_SUCCESS)?0:1;

unur_reset_errno();
/* reinit */
unur_reinit(gen);
n_tests_failed += (compare_sequence_gen(TESTLOG,233,gen,COMPARE_SAMPLE_SIZE)==UNUR_SUCCESS)?0:1;
unur_distr_free(distr);
unur_free(gen);
}
...
par = unur_dsrou_new(distr);
gen = unur_init(par);
n_tests_failed += (compare_sequence_gen_start(TESTLOG,246,gen,COMPARE_SAMPLE_SIZE)==UNUR_SUCCESS)?0:1;

unur_reset_errno();
unur_free(gen); gen = NULL;
unur_distr_free(distr); distr = NULL;
gen = unur_str2gen( "poisson(3.) & method = dsrou" );
n_tests_failed += (compare_sequence_gen(TESTLOG,251,gen,COMPARE_SAMPLE_SIZE)==UNUR_SUCCESS)?0:1;
...
n_tests_failed += (compare_sequence_gen(TESTLOG,265,gen,COMPARE_SAMPLE_SIZE)==UNUR_SUCCESS)?0:1;
unur_distr_free(distr);
unur_free(gen);
}
