...
unur_reset_errno();
n_tests_failed += (check_expected_NULL(TESTLOG,40,(unur_srou_new( distr )))==UNUR_SUCCESS)?0:1;
...
unur_reset_errno();
n_tests_failed += (check_expected_NULL(TESTLOG,46,(unur_srou_new( distr )))==UNUR_SUCCESS)?0:1;
...
unur_reset_errno();
/* pdf, mode, pdfarea */
n_tests_failed += (check_expected_NULL(TESTLOG,53,(unur_srou_new( distr )))==UNUR_SUCCESS)?0:1;
...
unur_reset_errno();
n_tests_failed += (check_expected_setfailed(TESTLOG,63,(unur_srou_set_r(par,2.)))==UNUR_SUCCESS)?0:1;
n_tests_failed += (check_errorcode(TESTLOG,63,UNUR_ERR_NULL)==UNUR_SUCCESS)?0:1;

unur_reset_errno();
n_tests_failed += (check_expected_setfailed(TESTLOG,66,(unur_srou_set_cdfatmode(par,0.)))==UNUR_SUCCESS)?0:1;
n_tests_failed += (check_errorcode(TESTLOG,66,UNUR_ERR_NULL)==UNUR_SUCCESS)?0:1;

unur_reset_errno();
n_tests_failed += (check_expected_setfailed(TESTLOG,69,(unur_srou_set_pdfatmode(par,1.)))==UNUR_SUCCESS)?0:1;
n_tests_failed += (check_errorcode(TESTLOG,69,UNUR_ERR_NULL)==UNUR_SUCCESS)?0:1;

unur_reset_errno();
n_tests_failed += (check_expected_setfailed(TESTLOG,72,(unur_srou_set_verify(par,1)))==UNUR_SUCCESS)?0:1;
n_tests_failed += (check_errorcode(TESTLOG,72,UNUR_ERR_NULL)==UNUR_SUCCESS)?0:1;

unur_reset_errno();
n_tests_failed += (check_expected_setfailed(TESTLOG,75,(unur_srou_set_usesqueeze(par,1)))==UNUR_SUCCESS)?0:1;
n_tests_failed += (check_errorcode(TESTLOG,75,UNUR_ERR_NULL)==UNUR_SUCCESS)?0:1;

unur_reset_errno();
n_tests_failed += (check_expected_setfailed(TESTLOG,78,(unur_srou_set_usemirror(par,1)))==UNUR_SUCCESS)?0:1;
...
unur_reset_errno();
n_tests_failed += (check_expected_setfailed(TESTLOG,86,(unur_srou_set_r(par,2.)))==UNUR_SUCCESS)?0:1;
n_tests_failed += (check_errorcode(TESTLOG,86,UNUR_ERR_PAR_INVALID)==UNUR_SUCCESS)?0:1;

unur_reset_errno();
n_tests_failed += (check_expected_setfailed(TESTLOG,89,(unur_srou_set_cdfatmode(par,0.)))==UNUR_SUCCESS)?0:1;
n_tests_failed += (check_errorcode(TESTLOG,89,UNUR_ERR_PAR_INVALID)==UNUR_SUCCESS)?0:1;

unur_reset_errno();
n_tests_failed += (check_expected_setfailed(TESTLOG,92,(unur_srou_set_pdfatmode(par,1.)))==UNUR_SUCCESS)?0:1;
n_tests_failed += (check_errorcode(TESTLOG,92,UNUR_ERR_PAR_INVALID)==UNUR_SUCCESS)?0:1;

unur_reset_errno();
n_tests_failed += (check_expected_setfailed(TESTLOG,95,(unur_srou_set_verify(par,1)))==UNUR_SUCCESS)?0:1;
n_tests_failed += (check_errorcode(TESTLOG,95,UNUR_ERR_PAR_INVALID)==UNUR_SUCCESS)?0:1;

unur_reset_errno();
n_tests_failed += (check_expected_setfailed(TESTLOG,98,(unur_srou_set_usesqueeze(par,1)))==UNUR_SUCCESS)?0:1;
n_tests_failed += (check_errorcode(TESTLOG,98,UNUR_ERR_PAR_INVALID)==UNUR_SUCCESS)?0:1;

unur_reset_errno();
n_tests_failed += (check_expected_setfailed(TESTLOG,101,(unur_srou_set_usemirror(par,1)))==UNUR_SUCCESS)?0:1;
...
unur_reset_errno();
n_tests_failed += (check_expected_setfailed(TESTLOG,111,(unur_srou_set_r(par,0.)))==UNUR_SUCCESS)?0:1;
n_tests_failed += (check_errorcode(TESTLOG,111,UNUR_ERR_PAR_SET)==UNUR_SUCCESS)?0:1;

unur_reset_errno();
n_tests_failed += (check_expected_setfailed(TESTLOG,114,(unur_srou_set_cdfatmode(par,-1.)))==UNUR_SUCCESS)?0:1;
n_tests_failed += (check_errorcode(TESTLOG,114,UNUR_ERR_PAR_SET)==UNUR_SUCCESS)?0:1;

unur_reset_errno();
n_tests_failed += (check_expected_setfailed(TESTLOG,117,(unur_srou_set_pdfatmode(par,-1.)))==UNUR_SUCCESS)?0:1;
...
unur_reset_errno();
n_tests_failed += (check_expected_setfailed(TESTLOG,137,(unur_srou_chg_verify(gen,1)))==UNUR_SUCCESS)?0:1;
n_tests_failed += (check_errorcode(TESTLOG,137,UNUR_ERR_GEN_INVALID)==UNUR_SUCCESS)?0:1;

unur_reset_errno();
n_tests_failed += (check_expected_setfailed(TESTLOG,140,(unur_srou_chg_cdfatmode(gen,1.)))==UNUR_SUCCESS)?0:1;
n_tests_failed += (check_errorcode(TESTLOG,140,UNUR_ERR_GEN_INVALID)==UNUR_SUCCESS)?0:1;

unur_reset_errno();
n_tests_failed += (check_expected_setfailed(TESTLOG,143,(unur_srou_chg_pdfatmode(gen,1.)))==UNUR_SUCCESS)?0:1;
...
UNUR_GEN   *gen = NULL;
   ...
   par = unur_srou_new(distr);
   gen = unur_init( par ); 
abort_if_NULL(TESTLOG, 149,    gen );


unur_reset_errno();
n_tests_failed += (check_expected_setfailed(TESTLOG,153,(unur_srou_chg_cdfatmode(gen,-1.)))==UNUR_SUCCESS)?0:1;
n_tests_failed += (check_errorcode(TESTLOG,153,UNUR_ERR_PAR_SET)==UNUR_SUCCESS)?0:1;

unur_reset_errno();
n_tests_failed += (check_expected_setfailed(TESTLOG,156,(unur_srou_chg_pdfatmode(gen,-1.)))==UNUR_SUCCESS)?0:1;
...
unur_reset_errno();
n_tests_failed += (check_expected_NULL(TESTLOG,167,(unur_init( par )))==UNUR_SUCCESS)?0:1;
...
n_tests_failed += (check_errorcode(TESTLOG,178,UNUR_ERR_GEN_DATA)==UNUR_SUCCESS)?0:1;
unur_distr_free(distr);
}
...
unur_reset_errno();
n_tests_failed += (check_expected_NULL(TESTLOG,189,(unur_init( par )))==UNUR_SUCCESS)?0:1;
n_tests_failed += (check_errorcode(TESTLOG,189,UNUR_ERR_GEN_DATA)==UNUR_SUCCESS)?0:1;
unur_distr_free(distr);
}
...
par = unur_srou_new( distr );
n_tests_failed += (check_expected_NULL(TESTLOG,199,(unur_init(par)))==UNUR_SUCCESS)?0:1;
n_tests_failed += (check_errorcode(TESTLOG,199,UNUR_ERR_DISTR_REQUIRED)==UNUR_SUCCESS)?0:1;
...
n_tests_failed += (check_errorcode(TESTLOG,205,UNUR_ERR_DISTR_REQUIRED)==UNUR_SUCCESS)?0:1;
unur_distr_free(distr);
}
...
UNUR_GEN   *gen = NULL;
   ...
   par = unur_srou_new(distr);
   gen = unur_init( par ); 
abort_if_NULL(TESTLOG, 213,    gen );


unur_reset_errno();
n_tests_failed += (check_expected_reinit(TESTLOG,217,(unur_reinit( gen )))==UNUR_SUCCESS)?0:1;
unur_distr_free(distr);
unur_free(gen);
}
...
unur_reset_errno();
n_tests_failed += (check_expected_reinit(TESTLOG,226,(unur_reinit( gen )))==UNUR_SUCCESS)?0:1;
unur_distr_free(distr);
unur_free(gen);
}
...
/* default algorithm */
par = unur_srou_new(distr);
n_tests_failed += (compare_sequence_par_start(TESTLOG,239,par,COMPARE_SAMPLE_SIZE)==UNUR_SUCCESS)?0:1;

unur_reset_errno();
/* default algorithm - verifying mode */
par = unur_srou_new(distr);
unur_srou_set_verify(par,1);
n_tests_failed += (compare_sequence_par(TESTLOG,244,par,COMPARE_SAMPLE_SIZE)==UNUR_SUCCESS)?0:1;

unur_reset_errno();
/* generalized algorithm, r=2 */
par = unur_srou_new(distr);
unur_srou_set_r(par,2.);
n_tests_failed += (compare_sequence_par_start(TESTLOG,249,par,COMPARE_SAMPLE_SIZE)==UNUR_SUCCESS)?0:1;
...
unur_srou_set_r(par,2.);
unur_srou_set_verify(par,1);
n_tests_failed += (compare_sequence_par(TESTLOG,255,par,COMPARE_SAMPLE_SIZE)==UNUR_SUCCESS)?0:1;
unur_distr_free(distr);
}
...
n_tests_failed += (compare_sequence_par_start(TESTLOG,267,par,COMPARE_SAMPLE_SIZE)==UNUR_SUCCESS)?0:1;
...
n_tests_failed += (compare_sequence_par(TESTLOG,273,par,COMPARE_SAMPLE_SIZE)==UNUR_SUCCESS)?0:1;
...
unur_srou_set_cdfatmode(par,0.5);
unur_srou_set_verify(par,1);
n_tests_failed += (compare_sequence_par(TESTLOG,279,par,COMPARE_SAMPLE_SIZE)==UNUR_SUCCESS)?0:1;
...
n_tests_failed += (compare_sequence_par_start(TESTLOG,298,par,COMPARE_SAMPLE_SIZE)==UNUR_SUCCESS)?0:1;
...
unur_srou_set_usemirror(par,1);
unur_srou_set_verify(par,1);
n_tests_failed += (compare_sequence_par(TESTLOG,304,par,COMPARE_SAMPLE_SIZE)==UNUR_SUCCESS)?0:1;
unur_distr_free(distr);
}
...
unur_srou_set_pdfatmode(par,0.1);
 run_verify_generator (TESTLOG,318,par);
n_tests_failed += (check_errorcode(TESTLOG,318,UNUR_ERR_GEN_CONDITION)==UNUR_SUCCESS)?0:1;
...
unur_srou_set_cdfatmode(par,0.5);
unur_srou_set_usesqueeze(par,1);
 run_verify_generator (TESTLOG,325,par);
n_tests_failed += (check_errorcode(TESTLOG,325,UNUR_ERR_GEN_CONDITION)==UNUR_SUCCESS)?0:1;
...
unur_srou_set_usesqueeze(par,1);
 run_verify_generator (TESTLOG,335,par);
n_tests_failed += (check_errorcode(TESTLOG,335,UNUR_ERR_GEN_CONDITION)==UNUR_SUCCESS)?0:1;
unur_distr_free(distr);
}
...
par = unur_srou_new(distr);
gen = unur_init(par);
n_tests_failed += (compare_sequence_gen_start(TESTLOG,348,gen,COMPARE_SAMPLE_SIZE)==UNUR_SUCCESS)?0:1;
...
/* reinit */
unur_reinit(gen);
n_tests_failed += (compare_sequence_gen(TESTLOG,370,gen,COMPARE_SAMPLE_SIZE)==UNUR_SUCCESS)?0:1;
unur_distr_free(distr);
unur_free(gen);
}
...
unur_srou_set_r(par,2.);
gen = unur_init(par);
n_tests_failed += (compare_sequence_gen_start(TESTLOG,381,gen,COMPARE_SAMPLE_SIZE)==UNUR_SUCCESS)?0:1;
...
unur_srou_set_verify(par,TRUE);
gen = unur_init(par);
n_tests_failed += (compare_sequence_gen_start(TESTLOG,421,gen,COMPARE_SAMPLE_SIZE)==UNUR_SUCCESS)?0:1;
...
n_tests_failed += (compare_sequence_gen(TESTLOG,427,gen,COMPARE_SAMPLE_SIZE)==UNUR_SUCCESS)?0:1;
unur_distr_free(distr);
unur_free(gen);
}
